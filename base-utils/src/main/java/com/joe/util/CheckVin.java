...
*<li>@throws </li>
*<li>@author xuby</li>
*<li>@date 2019/1/24 13:14</li>
*</ul>
*/
public class CheckVin {

    private static Map<Character, Integer> kv = Maps.newHashMap();

    private static Map<Integer, Integer> wv = Maps.newHashMap();
    ...
    public final static boolean isLegal(String vin) {
        if (null == vin) {
            ...
            if ("0123456789x".contains(vin.subSequence(8, 9))) {
                if ("x".equals(vin.subSequence(8, 9).toString())) {
                    resultInCode = 10;
                } else {
